...
let btnMute = document.querySelector('#mute_call');
let btnCamoff = document.querySelector('#cam_off');
let imgMic = document.querySelector('#mic')
let imgCam = document.querySelector('#cam')
        ...
        .then(stream => {
            ...
            btnMute.addEventListener('click',()=>{
                ...
                if(audioTracks[0].enabled){
                    imgMic.src= "/static/images/microphone_mute.png";
                }
                else{
                    imgMic.src = "/static/images/microphone.png";
                }
            })
            ...
            btnCamoff.addEventListener('click',()=>{
                ...
                if(videoTracks[0].enabled){
                    imgCam.src= "/static/images/cam_off.png";
                }
                else{
                    imgCam.src = "/static/images/cam_on.png";
                }
            })
